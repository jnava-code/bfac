    ...
    <div class="head-title">
      <div class="left">
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="#" id="current-page">Dividend</a></li>
          <li><i class='bx bx-chevron-right'></i></li>
          <li><a href="#" id="current-page">Transaction History</a></li>
          <li><i class="bx bx-chevron-right"></i></li>
          <li><a class="active" href="#" class="active">Archive</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="table-data">
      <div class="db">
        <div class="head">
          ...
          <button class="view-btn" onclick="window.location.href='transaction_div.html';"> 

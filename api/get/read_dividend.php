...
//         COALESCE(expense_totals.total_expenses, 0) AS total_expenses,
//         COALESCE(sales_totals.total_sales, 0) AS total_sales,
//         COALESCE(all_sales_totals.total_quantity_sales, 0) AS total_quantity_sales,
//         COALESCE(global_totals.all_total_paid_up_share_capital, 0) AS all_total_paid_up_share_capital,
//         COALESCE(global_totals.all_total_share_capital, 0) AS all_total_share_capital,
...
//         FROM admin_shares_list
//         GROUP BY member_id
//     ) AS share_totals ON share_totals.member_id = ashares.member_id

//     LEFT JOIN (
//         SELECT member_id, SUM(amount) AS total_expenses
//         FROM admin_expenses
//         GROUP BY member_id
//     ) AS expense_totals ON expense_totals.member_id = ashares.member_id

//     LEFT JOIN (
//         SELECT member_id, SUM(amount) AS total_sales
//         FROM admin_sales
//         GROUP BY member_id
//     ) AS sales_totals ON sales_totals.member_id = ashares.member_id

//     LEFT JOIN (
//         SELECT member_id, SUM(quantity) AS total_quantity_sales
//         FROM admin_sales
//         GROUP BY member_id
//     ) AS all_sales_totals ON all_sales_totals.member_id = ashares.member_id

//     -- Global totals across all members
//     LEFT JOIN (
//         SELECT 
//             SUM(paid_up_share_capital) AS all_total_paid_up_share_capital,
//             SUM(share_capital) AS all_total_share_capital
